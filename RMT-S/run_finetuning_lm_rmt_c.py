...
if __name__ == '__main__':
    ...
    if args.num_mem_tokens is not None:
        ...
        path = '/home/ubuntu/cog/baseline/wikitext103/pytorch_model.bin'
        ...
        # model.transformer.wte.requires_grad_(True) # Only finetuning wte
        #--------------------------------------------------------------------------------------------------------------------   
