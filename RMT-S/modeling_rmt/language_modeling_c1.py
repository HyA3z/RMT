...
class MemoryCell(torch.nn.Module):
    ...
    def forward(self, input_ids, memory_state=None, **kwargs):
        ...
        # For Language Module
        seg_kwargs = self.process_input(input_ids, memory_state, idx = 0, **kwargs)
        ...
        out, new_memory_state = self.process_output(out, out_c, **kwargs)
    ...
    def process_output(self, model_outputs, compress_outputs, **kwargs):
