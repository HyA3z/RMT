...
class MemoryCell(torch.nn.Module):
    ...
    def forward(self, input_ids, memory_state=None, **kwargs):
        ...
        out, new_memory_state = self.model(**seg_kwargs)
    ...
    def process_input(self, input_ids, memory_state, **kwargs):
        ...
        template = torch.cat([memory_state, inputs_embeds, memory_state], dim=1)
        seg_kwargs['attention_mask'] = kwargs['attention_mask']
        seg_kwargs['input_ids'] = None
        seg_kwargs['inputs_embeds'] = inputs_embeds
        seg_kwargs['attention_mask_mem'] = self.pad_attention_mask(kwargs['attention_mask'], template.shape)
